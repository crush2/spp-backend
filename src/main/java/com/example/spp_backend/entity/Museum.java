...
public class Museum {
    ...
    private List<MuseumEvaluation> museumEvaluations;
...
//    }
    ...
    public List<MuseumEvaluation> getMuseumEvaluations() {
        return museumEvaluations;
    }

    public void setMuseumEvaluations(List<MuseumEvaluation> museumEvaluations) {
        this.museumEvaluations = museumEvaluations;
    }
}
